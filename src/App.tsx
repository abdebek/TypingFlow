...
function App() {
  ...
  useEffect(() => {
    if (config.mode === 'words') {
      ...
      // Use duration-appropriate text for timed tests
  ...
  }, [currentView, handleKeyPress, restart, trackKeyPress, resetTracking, resetWPMTracking, addKeystroke, resetAdvancedMetrics]);
  ...
  const handleStartChallenge = (challengeId: string) => {
    // Switch to test view and configure for challenge
    setCurrentView('test');
